        ...
        for epoch in range(1, epochs + 1):
            ...
            if val_f1 > best_val_f1:
                ...
                if verbose and epoch % 10 == 0:
                    print(
                        f"Epoch {epoch:3d} | Loss: {train_loss:.4f} | Val F1: {val_f1:.4f} | ★ Best!"
                    )
            else:
                patience_counter += 1
                if verbose and epoch % 10 == 0:
                    print(
                        f"Epoch {epoch:3d} | Loss: {train_loss:.4f} | Val F1: {val_f1:.4f} | Patience: {patience_counter}/{patience}"
                    )
...
def train_and_evaluate(
    ...
    best_val_f1 = trainer.train(
        train_loader, val_loader, epochs=epochs, patience=patience, verbose=verbose
    )
